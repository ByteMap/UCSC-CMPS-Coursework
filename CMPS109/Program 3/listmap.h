...
//Specifies which class the iterator belongs to.
class listmap<Key,Value,Less>::iterator {
   private:
      //Only a listmap is permitted to build a valid iterator.
      friend class listmap<Key,Value,Less>;
      //node* where belongs to class listmap<> and returns the 
      //node to where-ever where has been declared.
