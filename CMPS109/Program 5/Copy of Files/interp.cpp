...
void interpreter::do_border (param begin, param end) {
   ...
   //set the color to the first argument then increment begin
   rgbcolor color {begin[0]};
   begin++;
   //Set the border color to the color.
   window::border_color = color;
   //And set the border thickness to the int of the second argument.
...
void interpreter::do_moveby (param begin, param end) {
   ...
   //Set the pixels to move to the int of the first argument.
