...
GLfloat window::border_thickness = 4;
rgbcolor window::border_color {"red"};
...
void window::display() {
   ...
   //First traverse through all of the objects
   for (auto& object: window::objects) {
      //And deselect every object before drawing.
      object.deselect();
   }
   //Now traverse through all of the objects a second time
   for (auto& object: window::objects) {
      //And set a counter to count the indices of the objects in the
      //list.
      size_t counter = 0;
