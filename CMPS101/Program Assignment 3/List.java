...
public class List {
	...
	public Object front() {          //If the list is not empty (size is greater than 0) return the data inside
	...
	public Object back() {         //If the list is not empty(size is greater than 0) return the data inside the
	...
	public boolean equals(Object obj) {
		...
		else if(L.length() == length()) {               //through the second screening where both of their temp
                                                        //nodes activated to go through both of the linked lists from
			while(L.temp != null && temp != null) {     //their heads to tails, and, if the loop detects that if
				if(!(node.equals(tempNode))) {          //any of their elements in the same indices differ, return
	...
	public void prepend(Object data) {     //Create a new node N that holds the new data. If the list is not empty, set
	...
	public void append(Object data) {      //Create a new node N that holds the new data. If the list is not empty, set
